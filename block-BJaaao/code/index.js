...
let isAdult = confirm("Are you a adult or not?");
...
alert(`The subtraction result is ${numA - numB}`);
alert(`The multiplication result is ${numA * numB}`);
console.log(`The result of subtraction is ${ numA - numB }`);
console.log(`The result of multiplication is ${ numA * numB }`);